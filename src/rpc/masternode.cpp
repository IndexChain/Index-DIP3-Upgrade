...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the indexnode owner Zcoin address\n"
            "  payee          - Print the indexnode payout Zcoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the indexnode operator public key\n"
            "  status         - Print indexnode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the indexnode voting Zcoin address\n"
        );
}
