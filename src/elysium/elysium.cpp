...
std::string elysium::strMPProperty(uint32_t propertyId)
{
    ...
    if (0x80000000 & propertyId) {
        ...
        switch (propertyId) {
            case ELYSIUM_PROPERTY_IDX: str = "IDX";
                break;
...
{
    if ((ELYSIUM_PROPERTY_IDX != propertyId) && !isTestEcosystemProperty(propertyId)) return true;
...
int input_mp_offers_string(const std::string& s)
{
    ...
    if (ELYSIUM_PROPERTY_IDX != prop_desired) return -1;
