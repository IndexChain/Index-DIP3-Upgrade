...
BOOST_AUTO_TEST_CASE(simple_send_restrictions)
{
    ...
    BOOST_CHECK(!IsTransactionTypeAllowed(0,                ELYSIUM_PROPERTY_IDX,  ELYSIUM_TYPE_SIMPLE_SEND, MP_TX_PKT_V0));
    BOOST_CHECK(!IsTransactionTypeAllowed(ELYSIUM_SEND_BLOCK,   ELYSIUM_PROPERTY_IDX,  ELYSIUM_TYPE_SIMPLE_SEND, MP_TX_PKT_V0));
    BOOST_CHECK(!IsTransactionTypeAllowed(MAX_BLOCK,        ELYSIUM_PROPERTY_IDX,  ELYSIUM_TYPE_SIMPLE_SEND, MAX_VERSION));
