...
CMPSPInfo::CMPSPInfo(const boost::filesystem::path& path, bool fWipe)
{
    ...
    implied_elysium.data = "Elysium serve as the binding between Index, smart properties and contracts created on the Elysium Layer.";
    ...
    implied_telysium.data = "Test Elysium serve as the binding between Index, smart properties and contracts created on the Elysium Layer.";
