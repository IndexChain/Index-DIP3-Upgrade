...
extern const char *INDEXNODEPAYMENTVOTE;
extern const char *INDEXNODEPAYMENTSYNC;
...
enum GetDataMsg
{
    ...
    MSG_SPORK,
    MSG_INDEXNODE_PAYMENT_VOTE,
    MSG_INDEXNODE_PAYMENT_BLOCK,
    MSG_INDEXNODE_ANNOUNCE,
    MSG_INDEXNODE_PING,
    MSG_INDEXNODE_VERIFY,
    MSG_TXLOCK_REQUEST,
    MSG_TXLOCK_VOTE,
    MSG_DSTX,
    DSQUEUE,
