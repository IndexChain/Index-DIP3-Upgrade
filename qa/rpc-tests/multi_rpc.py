...
class HTTPBasicsTest (BitcoinTestFramework):
    ...
    def setup_chain(self):
        super().setup_chain()
        #Append rpcauth to index.conf before initialization
        ...
        print(os.path.join(self.options.tmpdir+"/node0", "index.conf"))
        with open(os.path.join(self.options.tmpdir+"/node0", "index.conf"), 'a', encoding='utf8') as f:
            f.write(rpcauth+"\n")
            f.write(rpcauth2+"\n")
