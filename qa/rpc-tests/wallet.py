...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # This will raise an exception for attempting to get the private key of an Invalid Index address
        otp = self.get_otp("invalid")
        assert_raises_jsonrpc(-5, "Invalid Index address", self.nodes[0].dumpprivkey, "invalid", otp)

        # # This will raise an exception for attempting to set a label for an Invalid Index address
        # assert_raises_jsonrpc(-5, "Invalid Index address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_jsonrpc(-5, "Invalid Index address or script", self.nodes[0].importaddress, "invalid")
